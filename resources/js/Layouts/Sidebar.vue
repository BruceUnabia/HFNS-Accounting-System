...
<template>
    <div id="app" class="flex flex-col min-h-screen">
        <div class="flex flex-1 min-h-screen">
            <div class="bg-maroon text-white w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out " :class="width">
